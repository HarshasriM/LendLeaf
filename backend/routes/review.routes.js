...
//book routes 
router.get("/checkbookreviewuser/:bookId",isAuthenticated, bookReviewController.checkUserexist);
...
//lender routes
router.get("/checklenderreviewuser/:lenderId",isAuthenticated, lenderReviewController.checkUserexist);
